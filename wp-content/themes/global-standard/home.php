            ...
            ?>
                <li class="p-news__item">
                  <a href="<?php the_permalink(); ?>" class="p-news__card p-card-03">
                    ...
                    <?php else : ?>
                      <div class="p-card-03__img">
                        <img src="<?php echo esc_url(get_theme_file_uri("/assets/images/default-thumb01@2x.jpg")); ?>" alt="ビルの風景">
                      </div>
                    <?php endif; ?>
                    <div class="p-card-03__content">
                      ...
                      <div class="p-card-03__text">
                        ...
                        if (wp_is_mobile()) {
                          ...
                          if (mb_strlen($post->post_title, 'UTF-8') > 75) {
